            ...
            {open && (
                ...
                >
                    ...
                    <motion.div
                        ref={modalRef}
                        className={cn(
                            "min-h-[50%] max-h-[90%] sm:max-w-[600] md:max-w-[700] bg-white dark:bg-neutral-950 border border-transparent dark:border-neutral-800 rounded-2xl relative z-50 flex flex-col flex-1 overflow-hidden",
                            className,
                        )}
                        initial={{
                            opacity: 0,
...
export const ModalContent = ({ children, className }: { children: ReactNode; className?: string }) => {
    return <div className={cn("flex flex-col flex-1 px-2 py-10 md:p-10", className)}>{children}</div>;
};
